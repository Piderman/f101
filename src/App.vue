...
.text-team-1 { color: #00d2be }
.text-team-2 { color: #1e41ff }
.text-team-3 { color: #dc0000 }
.text-team-4 { color: #FFA300 }
.text-team-5 { color: #ff8700 }
.text-team-6 { color: #f596c8 }
.text-team-7 { color: #29ADFF }
.text-team-8 { color: #aa8e51 }
</style>
